...
class SprintEvaluatorTest {
    ...
    void walkableSurface_isPossibleAndCheaperThanWalk() {
        ...
        assertTrue(sprintResult.getCost() < walkResult.getCost());
    }

    @Test
    void nonWalkable_isImpossible() {
        SprintEvaluator evaluator = new SprintEvaluator(nonWalkableWorld(), normalBlock(), standardEntity());
